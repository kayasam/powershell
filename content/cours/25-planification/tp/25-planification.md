# Exercice 25 - L'Horloge de Zoro ⚔️
...
```powershell
# 1. L'action : lancer le script TP3
$action = New-ScheduledTaskAction `
    -Execute "pwsh.exe" `
    -Argument "-NonInteractive -File C:\Users\kaya\OneDrive\Obsidian\CoffreSam\Dawan\09-Powershell\Cours\Jour3\TP\TP3-Solution.ps1"
...
| ------------------- | ------------------- | ---------------- |
| Archivage quotidien | Tous les jours à 6h | TP3-Solution.ps1 |
